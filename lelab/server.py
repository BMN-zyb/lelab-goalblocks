...
from .goals import GoalDescriptionRequest, generate_goal_description
from .record import (
    DatasetInfoRequest,
    RecordingRequest,
    UploadRequest,
...
@app.post("/generate-goal-description")
def generate_description(request: GoalDescriptionRequest):
    """Generate a task prompt without retaining the supplied Qwen API key."""
    try:
        return {"description": generate_goal_description(request)}
